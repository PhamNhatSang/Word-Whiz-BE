...
export class Migration1717694273626 implements MigrationInterface {
    name = 'Migration1717694273626'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course_rate" DROP COLUMN "rate"`);
        await queryRunner.query(`ALTER TABLE "course_rate" ADD "rate" integer NOT NULL`);
    }
